            ...
            <div class="row">
                ...
                <div class="col-lg-9">
                    ...
                    <div class="row">
                        ...
                        <?php foreach ($productaktif as $row) : ?>
                            <div class="col-lg-4 col-md-6 mb-4">
                                <div class="card h-100">
                                    <a href="<?php echo site_url('home/detail/') . $row->product_id ?>"><img height="200px" weight="300px" class="card-img-top" src="<?php echo base_url('upload/product/') . $row->image1 ?>" alt=""></a>
                                    <div class="card-body">
                                        <h5 class="card-title">
