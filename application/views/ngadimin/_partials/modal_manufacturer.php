...
<div class="modal fade" id="modal_add_manufacturer" tabindex="-1" role="dialog" aria-labelledby="largeModal" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-hidden="true">x</button>
                <h3 class="modal-title" id="myModalLabel">Tambah Pabrikan</h3>
            </div>
            <form class="form-horizontal" method="post" action="<?php echo base_url() . 'ngadimin/master/manufacturer/simpan_manufacturer' ?>" enctype="multipart/form-data">
                <div class="modal-body">

                    <div class="form-group">
                        <label class="control-label col-xs-3" >Pabrikan</label>
                        <div class="col-xs-8">
                            <input name="manufacturer_name" class="form-control" type="text" placeholder="Nama Pabrikan" required>
                        </div>
                    </div>
...
//    $email = $row['email'];
    ?>
    <div class="modal fade" id="modal_edit_manufacturer<?php echo $row['manufacturer_id']; ?>" tabindex="-1" role="dialog" aria-labelledby="largeModal" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <button type="button" class="close" data-dismiss="modal" aria-hidden="true">x</button>
                ...
                <form class="form-horizontal" method="post" action="<?php echo base_url() . 'ngadimin/master/manufacturer/edit_manufacturer' ?>" enctype="multipart/form-data">
                    <div class="modal-body">
                        <div class="form-group">
                            <label class="control-label col-xs-3" >ID Pabrikan</label>
                            <div class="col-xs-8">
                                <input name="manufacturer_id" value="<?php echo $row['manufacturer_id']; ?>" class="form-control" type="text" placeholder="ID Pabrikan" readonly>
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="control-label col-xs-3" >Pabrikan</label>
                            <div class="col-xs-8">
                                <input name="manufacturer_name" value="<?php echo $row['manufacturer_name']; ?>" class="form-control" type="text" placeholder="Nama Pabrikan" required>
                            </div>
                        </div>
                    </div>
